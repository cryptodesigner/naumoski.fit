...
<section>
  ...
  <div class="title-bar">
		<h1 class="title-bar-title">
		  <span class="d-ib">Edit Schedule</span>
		</h1>

		<span><a style="color: white;" href="edit_schedule.php">MK</a> <span style="color: white;">|</span> <a style="color: white;" href="edit_schedule_en.php">EN</a></span>
		  ...
		  <div class="col-sm-6 col-sm-offset-3">
				<div class="md-form-group">
				  <select class="md-form-control" name="stanuvanje" id="stanuvanje" data-msg-required="Vreme na budenje" required>
						<option value="" disabled="disabled" selected="selected">Waking Time</option>
				...
				<div class="md-form-group">
		  		<select class="md-form-control" name="legnuvanje" id="legnuvanje" data-msg-required="Vreme na legnuvanje" required>
						<option value="" disabled="disabled" selected="selected">Sleeping Time</option>
				...
				<div class="md-form-group">
				  <input value="<?= $schedule->rabota; ?>" class="md-form-control" type="text" name="rabota" id="rabota" placeholder="Work / School (from - to) if any shift (from - to)">
				</div>
				<div class="md-form-group">
				  <input value="<?= $schedule->pauzi; ?>" class="md-form-control" type="text" name="pauzi" id="pauzi" placeholder="Breaks (from - to)">
				</div>
				<div class="md-form-group">
				  <input value="<?= $schedule->trening; ?>" class="md-form-control" type="text" name="trening" id="trening" placeholder="Training (preferred time)">
				</div>
				<div class="md-form-group">
				  <input value="<?= $schedule->cardio; ?>" class="md-form-control" type="text" name="cardio" id="cardio" placeholder="Cardio (preferred time)">
				</div>
				<div class="md-form-group">
				  <input value="<?= $schedule->description; ?>" class="md-form-control" type="text" name="description" id="description" placeholder="Other Physical Activities">
				</div>
				<button class="btn btn-default btn-block" type="submit">Update Schedule</button>
	  	</div>
		</div>
  </form>
</div>
