	...
	<div class="layout-content-body">
		<div class="title-bar">
		  <h1 class="title-bar-title">
			<span class="d-ib">Edit Basic Info</span>
		  </h1>
			...
			<div class="col-sm-6 col-sm-offset-3">
			  <div class="md-form-group">
				<select value="<?= $basic->pol; ?>" class="md-form-control" name="pol" id="pol" data-msg-required="Please indicate your gender." required>
					...
					<div class="md-form-group">
					  <input value="<?= $basic->visina; ?>" class="md-form-control" type="text" name="visina" id="visina" placeholder="Height (cm)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->tezina; ?>" class="md-form-control" type="text" name="tezina" id="tezina" placeholder="Weight (kg)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->alergija; ?>" class="md-form-control" type="text" name="alergija" id="alergija" placeholder="Alergies (if any)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->netolerantnost; ?>" class="md-form-control" type="text" name="netolerantnost" id="netolerantnost" placeholder="Intolerance (if any)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->odbivnost; ?>" class="md-form-control" type="text" name="odbivnost" id="odbivnost" placeholder="rejection (if any)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->zaboluvanja; ?>" class="md-form-control" type="text" name="zaboluvanja" id="zaboluvanja" placeholder="Diseases (if any)">
					</div>
					<div class="md-form-group">
					  <input value="<?= $basic->iskustvo; ?>" class="md-form-control" type="text" name="iskustvo" id="iskustvo" placeholder="Experience in gym (if any)">
					</div>
					<button class="btn btn-default btn-block" type="submit">Update Basic Info</button>
				 </div>
			</div>
		</form>
	</div>
