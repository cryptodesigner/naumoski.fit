              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li><a href="clients.php">Show Clients</a></li>
                ...
                <li class="sidenav-item has-subnav">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li><a href="techniques.php">Show Techniques</a></li>
                ...
                <li class="sidenav-item has-subnav">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li><a href="exercises.php">Show Exercises</a></li>
                ...
                <li class="sidenav-item has-subnav">
                  <a href="#" aria-haspopup="true">
                    <span class="sidenav-icon icon icon-cutlery"></span>
                    <span class="sidenav-label">Meals</span>
                  </a>
                  <ul class="sidenav-subnav collapse">
                    <li class="sidenav-subheading">Meals</li>
                    <li><a href="meals.php">Show Meals</a></li>
                ...
                <li class="sidenav-item has-subnav">
                  ...
                  <ul class="sidenav-subnav collapse">
                    ...
                    <li><a href="recepts.php">Show Recepts</a></li>
