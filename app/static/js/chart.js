 ...
 */
    ...
    function Fe(t, e) {
        ...
        n && !("" + n).match(Te) && (console.warn('Invalid font style specified: "' + n + '"'),
        n = "");
        const o = {
    ...
    class Li {
        ...
        _dataCheck() {
            ...
            U(i) ? t._data = function(t) {
                ...
                return i
            }(i) : t._data !== i && (t._data && (ce(t._data, t),
            Ai(t._cachedMeta)),
    ...
    function dn(t) {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = cn(t, h + 1),
                l && c && (Tt(e[h], 0, ln) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function fn(t, e, i, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Gt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = un(o.cp1x, e.left, e.right),
                o.cp1y = un(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = un(o.cp2x, e.left, e.right),
    ...
    class Nn {
        ...
        datasetAnimationScopeKeys(t, e) {
            return Wn(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, "transitions." + e], ["datasets." + t, ""]]))
        }
        datasetElementScopeKeys(t, e) {
            return Wn(`${t}-${e}`, (()=>[[`datasets.${t}.elements.${e}`, "datasets." + t, "elements." + e, ""]]))
        }
        pluginScopeKeys(t) {
            const e = t.id;
    ...
    function Gn(t) {
        return Kn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
        ...
        buildOrUpdateScales() {
            ...
            J(s, (i=>{
                const s = i.options
                  ...
                  , r = In(a, s)
                  , l = K(s.type, i.dtype);
                void 0 !== s.position && Yn(s.position, r) === Yn(i.dposition) || (s.position = i.dposition),
                o[a] = !0;
                let c = null;
    ...
    function Mo(t, e) {
        ...
        e.fullCircles && function(t, e, i) {
            const {x: n, y: o, startAngle: s, endAngle: a, pixelMargin: r} = e
              ...
              , c = e.innerRadius + r;
            let h;
            for (i && (e.endAngle = e.startAngle + _t,
            _o(t, e),
            e.endAngle = a,
            e.endAngle === e.startAngle && (e.endAngle += _t,
            e.fullCircles--)),
            t.beginPath(),
    ...
    function Fo(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Vo(e, "left", "right", t.base > t.x) : Vo(e, "bottom", "top", t.base < t.y),
        i[e] = !0,
        i) : i
    }
    function Vo(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = Bo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = Bo(t, e, i),
        t
    }
    function Bo(t, e, i) {
    ...
    var ds = {
        ...
        beforeDraw(t, e, i) {
            ...
            for (let e = o.length - 1; e >= 0; --e) {
                const i = o[e].$filler;
                i && (i.line.updateControlPoints(s),
                n && hs(t.ctx, i, s))
            }
        },
    ...
    class Ls extends Xi {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                y = Math.floor(f / M) * M,
                v = Math.ceil(g / M) * M,
                p && m && n && Rt((s - o) / n, M / 1e3) ? (w = Math.min((s - o) / M, l),
                M = (s - o) / w,
                y = o,
                v = s) : x ? (y = p ? o : y,
                v = m ? s : v,
                ...
                y <= o && k++,
                Tt(Math.round((y + k * M) * _) / _, o, b * (h ? ("" + o).length : 1)) && k++); k < w; ++k)
                    i.push({
    ...
    function Xs(t, e) {
        ...
        null === a ? null : (o && (a = "week" !== o || !At(s) && !0 !== s ? i.startOf(a, o) : i.startOf(a, "isoWeek", s)),
        +a)
    }
    function qs(t, e, i, n) {
        const o = Ys.length;
    ...
    class Zs extends Xi {
        ...
        _generate() {
            ...
            u++)
                Ks(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Ks(h, d, g),
    ...
    return Jn.register(bo, ta, Yo, As),
    Jn.helpers = {
        ...Cn
    },
    Jn._adapters = oo,
